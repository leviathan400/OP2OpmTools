...
Public Class fMain
    ...
    Public Version As String = "0.1.1"
    ...
    ' Helper function to check if a string is a valid building type
    ...
    ' Helper function to get color number from color name
    ...
    ' Helper function to convert direction string to numeric value
    ...
    ' Helper function to get yield value
    ...
    ' Helper function to get variant value
    ...
    ' Class to represent a line of walls or tubes
    ...
    ' Helper function to group wall/tubes into lines for CreateTubeOrWallLine calls
    ...
    ' Get wall/tubes that couldn't be grouped into lines
    ...
    ' Helper function to map cargo type from OPM to the correct map_id enum value
    ...
    ' Helper function to get truck cargo type
    ...
    ' Helper function to check if a string is a valid map_id enum value
    ...
    ' Helper function to get the human-readable name for a starship part ID
